...
- Verify `window.__levelsjamDebug.getRuntimeRadianceCascadeState()` reports GPU cascade dimensions, a nonzero `gpuUpdateCount`, and a recent `latestGpuUpdateMs` value when the scene is rendered.
