...
- The loading overlay remains visible until general scene assets, surface lightmaps, and all volumetric-lightmap coefficient/depth probe data within 6 meters of the player's starting position are loaded.
