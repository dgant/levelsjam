...
- The loading overlay remains visible until general scene assets, surface lightmaps, and the local startup volumetric-lightmap probe set needed around the player are loaded.
