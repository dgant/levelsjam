...
[] You know that rule about having a one-cell passage between levels? That passage should be *outside* the layout of the level and not in it. For example, right now Chamber 1's one-cell passage is inside the rectangle that comprises the room. This is in error
...
[] When you are in maze-00N, the outer walls are unlit.
