    ...
    for (const c of this.visibleMeshes) {
      if (c.material) {
        ...
        if (originalMaterial.normalMap) {
          mrtMaterial.defines.USE_NORMALMAP = "";
          mrtMaterial.defines.USE_NORMALMAP_TANGENTSPACE = "";
        } else {
          delete mrtMaterial.defines.USE_NORMALMAP;
          delete mrtMaterial.defines.USE_NORMALMAP_TANGENTSPACE;
        }
