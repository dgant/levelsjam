 ...
 + Chamber 1
 Chamber 1 is 5 tiles wide and 14 tiles long. In addition to the entrance from Entrance, it has an exit to Maze 1 and Maze 2 on the left wall, and an exit to Maze 3 and Maze 4 on the right wall. Put a torch on each wall next to an exit.
 
 + Maze 1
 A standard maze using the original requirements for a maze.
 + Maze 2
 A standard maze using the original requirements for a maze.
 + Maze 3
 A standard maze using the original requirements for a maze.
